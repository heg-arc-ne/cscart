...
if ($mode == 'manage') {
    ...
    Registry::get('view')->assign('usergroups', fn_get_usergroups(array('status' => array('A', 'H')), DESCR_SL));
    ...
    Registry::get('view')->assign('countries', fn_get_simple_countries(true, CART_LANGUAGE));
    Registry::get('view')->assign('states', fn_get_all_states());
    Registry::get('view')->assign('usergroups', fn_get_usergroups(array('status' => array('A', 'H')), CART_LANGUAGE));
