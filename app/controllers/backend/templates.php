...
if ($mode == 'manage') {
    ...
    if (file_exists($tpath)) {
        ...
        foreach ($show_path as $id => $path) {
            ...
            Registry::get('view')->assign('current_path', fn_normalize_path(str_replace($root_dir, '', $base_path)));
            ...
            $_list = Registry::get('view')->fetch('views/templates/components/file_list.tpl');
            if (!empty($files_list)) {
    ...
    Registry::get('view')->assign('current_path', str_replace($root_dir, '', $tpath));
    Registry::get('view')->assign('items', $items);

    Registry::get('ajax')->assign('current_path', str_replace($root_dir, '', $tpath));
    Registry::get('ajax')->assign('files_list', Registry::get('view')->fetch('views/templates/components/file_list.tpl'));
    exit;
