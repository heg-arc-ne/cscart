...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($mode == 'shipping_estimation') {
        ...
        if (Registry::get('settings.Checkout.display_shipping_step') != 'Y' && fn_allowed_for('ULTIMATE')) {
            Registry::get('view')->assign('show_only_first_shipping', true);
        }
...
// All checkout steps
    ...
    Registry::get('view')->assign('display_steps', $display_steps);
    ...
    Registry::get('view')->assign('final_step', $final_step);
    ...
    Registry::get('view')->assign('next_step', $next_step);
    ...
    Registry::get('view')->assign('usergroups', fn_get_usergroups(array('type' => 'C', 'status' => 'A'), CART_LANGUAGE));
