...
function fn_correct_gift_certificate(&$gift_cert_data)
{
    ...
    if ($currencies[CART_SECONDARY_CURRENCY]['is_primary'] != 'Y') {
        ...
        $min_amount = fn_format_price($min_amount * $currencies[CART_SECONDARY_CURRENCY]['coefficient']);
        $max_amount = fn_format_price($max_amount * $currencies[CART_SECONDARY_CURRENCY]['coefficient']);
    }
